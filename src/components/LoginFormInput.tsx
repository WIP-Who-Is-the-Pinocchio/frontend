...
interface LoginFormInput {
  ...
  placeholder?: string;
  // required: boolean;
  // pattern?: RegisterOptions<AdminAuthFormInputs>["pattern"];
  // register: UseFormRegister<AdminAuthFormInputs>;
...
const LoginFormInput: React.FC<LoginFormInput> = forwardRef(
